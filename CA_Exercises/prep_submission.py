...
if scoreboard[0] and scoreboard[1] and scoreboard[2] and scoreboard[3]:
    ...
    _score_1 = 0.0
print(f'\033[1m\tFuntional pipelined MULT2:\t{_score_1} pts\033[0m ({scoreboard[0]} cc, {scoreboard[1]} cc, {scoreboard[2]} cc, {scoreboard[3]} cc)\n')
if scoreboard[4]:
    _score_2 = 0.5
else:
    _score_2 = 0.0
print(f'\033[1m\tFuntional pipelined MULT3:\t{_score_2} pts\033[0m ({scoreboard[4]} cc)\n')
if scoreboard[5]:
    _score_3 = 0.5
    if scoreboard[5] == 844:
        _score_3 += 0.5
    ...
    _score_3 = 0.0
print(f'\033[1m\tFuntional pipelined MULT4:\t{_score_3} pts\033[0m ({scoreboard[5]} cc)\n')
print('\t'+'-'*42)
print(f'\033[1m\tTotal Score:\t{_score_1+_score_2+_score_3} pts\n\033[0m')
